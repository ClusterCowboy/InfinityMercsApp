...
public sealed class CCUnitFilterPopupOptions
{
...
public sealed class CCUnitFilterCriteria
{
    ...
    public static CCUnitFilterCriteria None { get; } = new();
}

public partial class CCUnitFilterPopupPage : ContentView
{
    public event EventHandler<CCUnitFilterCriteria>? FilterArmyApplied;
    ...
    public CCUnitFilterPopupPage()
        : this(new CCUnitFilterPopupOptions(), CCUnitFilterCriteria.None, lieutenantOnlyUnits: false, teamsView: true)
    {
    }

    public CCUnitFilterPopupPage(
        CCUnitFilterPopupOptions options,
        CCUnitFilterCriteria? existingCriteria = null,
        ...
        bool teamsView = false)
    {
        ...
        BindingContext = this;
        ApplySelections(existingCriteria ?? CCUnitFilterCriteria.None, minPoints, maxPoints, lieutenantOnlyUnits, teamsView);
    }
    ...
    private void OnFilterArmyClicked(object? sender, EventArgs e)
    {
        ...
        var criteria = new CCUnitFilterCriteria
        {
